...
JMS_JOB_VARIABLE_HELP = {
    JMS_USERNAME: _('The current user`s username of fortserver'),
    JMS_ASSET_ID: _('The id of the asset in the fortserver'),
    JMS_ASSET_TYPE: _('The type of the asset in the fortserver'),
    JMS_ASSET_CATEGORY: _('The category of the asset in the fortserver'),
    JMS_ASSET_NAME: _('The name of the asset in the fortserver'),
    JMS_ASSET_ADDRESS: _('Address used to connect this asset in fortserver'),
    JMS_ASSET_PORT: _('Port used to connect this asset in fortserver'),
