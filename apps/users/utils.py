...
logger = logging.getLogger('fortserver.users')
...
def get_redirect_client_url(request):
    ...
    message_data = {
        ...
        'message': _("Redirecting to fortserver Client"),
...
def generate_otp_uri(username, otp_secret_key=None, issuer="fortserver"):
