...
from fortserver.vendor import get_vendor_value, is_default_vendor
...
default_interface = dict((
    ...
    ('login_title', get_vendor_value('login_title', default=_('fortserver - An open-source PAM'))),
...
def fortserver_processor(request):
    # Setting default pk
