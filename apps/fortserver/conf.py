...
class Config(dict):
    ...
    defaults = {
        ...
        'SSH_CA_OPENBAO_ROLE': 'fortserver',
        ...
        # 导航栏 帮助
        'HELP_DOCUMENT_URL': 'https://fortserver.com/docs',
        ...
        'CHAT_AI_DELEGATION_ISSUER': 'fortserver-ai',
        'CHAT_AI_DELEGATION_AUDIENCE': 'fortserver-core',
