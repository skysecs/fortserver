...
logger = logging.getLogger('fortserver.conf')
...
class Config(dict):
    ...
    defaults = {
        ...
        # 导航栏 帮助
        'HELP_DOCUMENT_URL': 'https://docs.fortserver.org/zh/v3/',
        'HELP_SUPPORT_URL': 'http://www.fortserver.org/support/',
        ...
        'ANSIBLE_RECEPTOR_SOCK_PATH': '/opt/fortserver/data/share/control.sock'
    }
