...
CSRF_FAILURE_VIEW = 'fortserver.views.other.csrf_failure'
...
MIDDLEWARE = [
    'fortserver.middleware.StartMiddleware',
    *PRE_CUSTOM_MIDDLEWARES,
    ...
    'fortserver.middleware.CsrfCheckMiddleware',
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
    'fortserver.middleware.TimezoneMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'fortserver.context_processor.fortserver_processor',
...
WSGI_APPLICATION = 'fortserver.wsgi.application'
...
# Email config
EMAIL_BACKEND = 'fortserver.rewriting.smtp.EmailBackend'
