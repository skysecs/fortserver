...
from fortserver.rewriting.storage.servers import StaticFileServer
...
class StaticFileServerTests(SimpleTestCase):
    ...
    @patch('fortserver.rewriting.storage.servers.NginxXAccelRedirectServer.serve')
    @patch('fortserver.rewriting.storage.servers.DjangoServer.serve', return_value=sentinel.response)
    ...
    @patch('fortserver.rewriting.storage.servers.NginxXAccelRedirectServer.serve', return_value=sentinel.response)
    @patch('fortserver.rewriting.storage.servers.DjangoServer.serve')
