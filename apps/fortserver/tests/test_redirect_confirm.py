...
from fortserver.middleware import SafeRedirectMiddleware
from fortserver.views.other import RedirectConfirm
    ...
    def test_oauth_redirect_reaches_confirmation_without_changing_callback_parameters(self):
        for scheme in ('jms2',):
            with self.subTest(scheme=scheme):
                ...
                with patch('fortserver.middleware.reverse', return_value='/core/redirect/confirm/'):
