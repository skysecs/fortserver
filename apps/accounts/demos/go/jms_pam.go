...
func NewfortserverPAM(endpoint, keyID, keySecret, orgID string) *fortserverPAM {
	if orgID == "" {
		orgID = DefaultOrgId
	}
	return &fortserverPAM{
		Endpoint:   endpoint,
		KeyID:      keyID,
		KeySecret:  keySecret,
		OrgID:      orgID,
...
func (c *fortserverPAM) SignRequest(r *http.Request) error {
...
func (c *fortserverPAM) Send(req *SecretRequest) (Secret, error) {
