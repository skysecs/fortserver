...
ASSISTANTS = {
    'general': AssistantProfile(
        key='general',
        name='fortserver assistant',
        description='General fortserver questions without access to live Core data.',
        instructions=(
            'Act as a general fortserver product assistant. Answer greetings, concepts, usage guidance, and other '
            'general questions directly. You cannot access the current fortserver environment or call Core APIs. '
        ...
        starter_prompts=(
            'What can fortserver help me manage?',
            'Explain how to use fortserver safely.',
        ),
    ),
    'management': AssistantProfile(
        key='management',
        name='Management assistant',
        description='Manage permitted fortserver resources and settings.',
        instructions=(
            'Act as a fortserver management assistant with full permitted Core operation access. Prefer read-only '
        ...
        admin_only=True,
        starter_prompts=(
            'Summarize the current fortserver environment.',
