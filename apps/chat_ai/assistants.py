...
ASSISTANTS = {
    'general': AssistantProfile(
        ...
        description='General fortserver questions and all permitted Core operations.',
        instructions=(
            'Act as a general fortserver assistant with full Core operation access. Prefer read-only inspection '
