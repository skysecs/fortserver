...
ASSISTANTS = {
    'general': AssistantProfile(
        ...
        description='General fortserver questions and permitted operations.',
        instructions=(
            'Act as a general fortserver assistant. Prefer read-only inspection before proposing any change. '
