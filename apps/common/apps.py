...
class CommonConfig(AppConfig):
    ...
    def ready(self):
        ...
        self._auto_register_fortserver_client_if_not_exists()

    def _auto_register_fortserver_client_if_not_exists(self):
        """ Auto register fortserver Client application if not exists.  """
