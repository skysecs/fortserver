...
SERVICE_TOKEN_FILE="/openbao/bootstrap/fortserver-token.json"
POLICY_FILE="/tmp/fortserver-policy.hcl"
...
bao policy write fortserver "${POLICY_FILE}" >/dev/null
